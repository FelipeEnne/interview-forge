...
export const REACT_CATEGORIES: readonly CategoryDefinition<ReactQuestionCategory>[] = [
  ...
  { id: "state", displayName: { en: "State & Updates", pt: "State e Updates" } },
  { id: "hooks", displayName: { en: "Hooks & Effects", pt: "Hooks e Effects" } },
  {
    id: "rendering",
    displayName: {
  ...
  { id: "shared-state", displayName: { en: "Shared State", pt: "State Compartilhado" } },
  {
    id: "performance",
    displayName: {
